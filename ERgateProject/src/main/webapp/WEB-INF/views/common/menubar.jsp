...
<body>
	<div class="menubar">
		...
		<div id="infoArea" onclick="매핑값">
			...
			<div id="profile_area">
				<div id="profileImg">
					<img src="${pageContext.servletContext.contextPath }/resources/siteImgs/3531276919_gdNCw120_glffj3_1476631182027.jpg" alt="">
				</div>
			</div>
			<!-- 프로필사진 영역 -->
			<!-- 사용자 정보 영역 -->
			<div id="info_userInfoArea">
				...
				<span>개발1팀 / 팀장</span> <br> <a href="logout.ma"
