	...
	<div class="menubar">
		...
		<div id="infoArea" onclick="매핑값">
			...
			<div id="info_userInfoArea">
				<p id="info_userName">
					${ loginUser.empName }<a href="mypage.ma"><svg id="info_setting"
				...
				<span style="line-height:160%">${ loginUser.deptTitle } / ${ loginUser.rankTitle }</span> <br> <a href="logout.ma"
					...
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
						...
						<path
                         ...
                         2zm6-9h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6h1.9c0-1.71 1.39-3.1 3.1-3.1 1.71
                          ...
                          2-2V10c0-1.1-.9-2-2-2zm0 12H6V10h12v10z" /></svg><a href="logout.ma" style="text-decoration:none; color:black;">로그아웃</a>
				</a>
			</div>
			<!-- 사용자 정보 영역 -->
			<!-- 출,퇴근버튼 영역 -->
			...
			<table id="naviIcons">
				<tr>
					...
					<th onclick="location.href='atList.at';"><svg class="menuIcons"
						...
						<br>
					<span>근태</span></th>
					<th onclick="location.href='waitingList.si?currentPage=1';"><svg class="menuIcons"
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
							fill="black" width="48px" height="48px">
							<path d="M0 0h24v24H0z" fill="none" />
							<path
				...
				<tr>
					...
					<span>공지</span></th>
					<th onclick="location.href='list.bo?currentPage=1';"><svg class="menuIcons"
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
							fill="black" width="48px" height="48px">
							<path d="M0 0h24v24H0z" fill="none" />
							<path
				...
				<tr></tr>
				<tr>
					<th onclick="location.href='currentStatus.me?currentPage=1';"><svg class="menuIcons"
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
							fill="black" width="48px" height="48px">
							<path d="M0 0h24v24H0z" fill="none" />
							<path
						...
						<br>
					<span>회의실</span></th>
					<th onclick="location.href='myReserve.ve?currentPage=1';" h><svg class="menuIcons"
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
							fill="black" width="48px" height="48px">
							<path
